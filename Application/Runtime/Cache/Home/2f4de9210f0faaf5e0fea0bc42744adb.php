<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html>
    ...
    <body class="home-index home-product">
        <header>
            <div class="container">
                ...
                <ul class="nav">
                    ...
                    <li>
                        <a href="<?php echo U('home/index/product');?>"  class="active">服务产品</a>
                    </li>
                    <li>
        ...
        <div class="product-content">
            <div class="product-lists">
                <?php if(is_array($product)): $i = 0; $__LIST__ = $product;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><a href="<?php echo U('home/index/pdetail',array('id'=>$data['id']));?>" class="item">
                        <table>
